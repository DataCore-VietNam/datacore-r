...
Thanks for your interest. All contributions -- bug reports, documentation fixes, new features -- are welcome.
...
- Internal helpers go in `R/utils.R` with `@noRd`; exported functions get full `@param`/`@return`/`@examples` roxygen blocks
...
- Minimal reproducible example (code + `sessionInfo()` output)
- OS, R version, and package version

## License

By contributing you agree your contributions are licensed under [MIT](LICENSE.md).
