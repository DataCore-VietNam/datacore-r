...
[![Codecov](https://codecov.io/gh/DataCore-VietNam/datacore-r/graph/badge.svg)](https://codecov.io/gh/DataCore-VietNam/datacore-r)
[![CRAN status](https://www.r-pkg.org/badges/version/datacore)](https://CRAN.R-project.org/package=datacore)
[![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE.md)
<!-- badges: end -->

Official R client for [DataCore](https://datacore.vn) -- Vietnamese financial, alternative, and economic data. Tibble-native, tidyverse-compatible, with built-in pagination, retry, and rate-limit handling.
...
|---|---|---|
| `datacore_client()` | Create a client | Yes |
...
All API errors surface as classed conditions you can catch with `tryCatch()`:
